...
[previous post](/arch-install) with the latest configuration of my machine. I have also update my
...
::: warning
USE_OVERLAYFS feature requires a Linux kernel version of 3.18.0 or greater to work.
:::
